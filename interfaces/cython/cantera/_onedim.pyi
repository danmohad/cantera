...
class SprayFlowBase(FlowBase):
    ...
    @property
    def spray_fuel(self) -> str: ...
    @property
    def spray_inlet(self) -> Literal["left", "right"]: ...
    @property
    def free_flow_no_slip(self) -> bool: ...
    @property
    def minimum_droplet_diameter(self) -> float: ...
    @property
    def droplet_reversal_check(self) -> bool: ...
    @property
    def evaporation_rate(self) -> Array: ...
    @property
    def spray_heat_transfer_rate(self) -> Array: ...
    @property
    def spray_gas_energy_source(self) -> Array: ...
    @property
    def droplet_diameter(self) -> Array: ...
    @property
    def droplet_reynolds_number(self) -> Array: ...
    @property
    def droplet_nusselt_number(self) -> Array: ...
    @property
    def droplet_sherwood_number(self) -> Array: ...

class SprayFreeFlow(SprayFlowBase): ...
class SprayUnstrainedFlow(SprayFlowBase): ...
class SprayAxisymmetricFlow(SprayFlowBase): ...
